...
def special(char_name: str, char_class: str) -> str:
    """Calculate special attack function."""
    if char_class == 'warrior':
...
if __name__ == '__main__':
    ...
    print(start_training(str(char_name), str(char_class)))
